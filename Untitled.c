...
{
    if((0 <= x <= 7) && (0 <= y <= 7)) // x, y의 위치가 0~7일 떄
    {
        if(((2 <= x <= 7) && (1 <= y <= 7)) && ((chessPos[x-2][y-1] == chessPiece[0]) || (chessPos[x-2][y-1][0] == BLACK)))
            movable[x-2][y-1] = 1;
        else
            wrongMove_Alert();

        if(((1 <= x <= 7) && (2 <= y <= 7)) && ((chessPos[x-1][y-2] == chessPiece[0]) || (chessPos[x-1][y-2][0] == BLACK)))
            movable[x-1][y-2] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 6) && (2 <= y <= 7)) && ((chessPos[x+1][y-2] == chessPiece[0]) || (chessPos[x+1][y-2][0] == BLACK)))
            movable[x+1][y-2] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 5) && (1 <= y <= 7)) && ((chessPos[x+2][y-1] == chessPiece[0]) || (chessPos[x+2][y-1][0] == BLACK)))
            movable[x+2][y-1] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 5) && (0 <= y <= 6)) && ((chessPos[x+2][y+1] == chessPiece[0]) || (chessPos[x+2][y+1][0] == BLACK)))
            movable[x+2][y+1] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 6) && (0 <= y <= 5)) && ((chessPos[x+1][y+2] == chessPiece[0]) || (chessPos[x+1][y+2][0] == BLACK)))
            movable[x+1][y+2] = 1;
        else
            wrongMove_Alert();

        if(((1 <= x <= 7) && (0 <= y <= 5)) && ((chessPos[x-1][y+2] == chessPiece[0]) || (chessPos[x-1][y+2][0] == BLACK)))
            movable[x-1][y+2] = 1;
        else
            wrongMove_Alert();

        if(((2 <= x <= 7) && (0 <= y <= 6)) && ((chessPos[x-2][y+1] == chessPiece[0]) || (chessPos[x-2][y+1][0] == BLACK)))
            movable[x-2][y+1] = 1;
        else
            wrongMove_Alert();
    }
...
void blackNight(int x, int y)
{
    if ((0 <= x <= 7) && (0 <= y <= 7))
    {
        if(((2 <= x <= 7) &&(1 <= y <= 7)) && ((chessPos[x-2][y-1] == chessPiece[0]) || (chessPos[x-2][y-1][0] == WHITE)))
            movable[x-2][y-1] = 1;
        else
            wrongMove_Alert();

        if(((1 <= x <= 7) && (2 <= y <= 7)) && ((chessPos[x-1][y-2] == chessPiece[0]) || (chessPos[x-1][y-2][0] == WHITE)))
            movable[x-1][y-2] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 6) && (2 <= y <= 7)) && ((chessPos[x+1][y-2] == chessPiece[0]) || (chessPos[x+1][y-2][0] == WHITE)))
            movable[x+1][y-2] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 5) && (1 <= y <= 7)) && ((chessPos[x+2][y-1] == chessPiece[0]) || (chessPos[x+2][y-1][0] == WHITE)))
            movable[x+2][y-1] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 5) && (0 <= y <= 6)) && ((chessPos[x+2][y+1] == chessPiece[0]) || (chessPos[x+2][y+1][0] == WHITE)))
            movable[x+2][y+1] = 1;
        else
            wrongMove_Alert();

        if(((0 <= x <= 6) && (0 <= y <= 5)) && ((chessPos[x+1][y+2] == chessPiece[0]) || (chessPos[x+1][y+2][0] == WHITE)))
            movable[x+1][y+2] = 1;
        else
            wrongMove_Alert();

        if(((1 <= x <= 7) && (0 <= y <= 5)) && ((chessPos[x-1][y+2] == chessPiece[0]) || (chessPos[x-1][y+2][0] == WHITE)))
            movable[x-1][y+2] = 1;
        else
            wrongMove_Alert();

        if(((2 <= x <= 7) && (0 <= y <= 6)) && ((chessPos[x-2][y+1] == chessPiece[0]) || (chessPos[x-2][y+1][0] == WHITE)))
            movable[x-2][y+1] = 1;
        else
            wrongMove_Alert();
    }
